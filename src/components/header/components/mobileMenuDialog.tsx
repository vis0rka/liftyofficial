...
const MobileMenuDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
    <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left', className)} {...props} />
)
MobileMenuDialogHeader.displayName = 'DialogHeader'

const MobileMenuDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
