          ...
          <div className="flex flex-col justify-center items-center lg:space-x-12 space-y-10 lg:flex-row">
            <div className="w-full space-y-4 flex flex-col items-center justify-center lg:w-1/2">
              ...
              <p className="text-center">
                Anytime and anywhere! It provides ideal support for short
                distances, like when you need to carry your toddler up the
                stairs in a building without an elevator, or when you're
                accompanying the “big sibling” to kindergarten or school. You'll
                also love it during vacations, from the airport all the way to
                the sandy beach, where strollers can no longer manage. It's
                small enough to take anywhere, yet big enough to enhance the
